...
const UnstakingCompleteScreen = ({amount, rewards, symbol}) => {
  ...
  const onPressToMyWallet = () => {
    Actions.reset('tabBar');
    Actions.walletScreen();
...
export default UnstakingCompleteScreen;
